...
\begin{enumerate}
    ...
    \begin{figure}[!ht]
    \centering
    \input{codes/fig_1.tex}  % Specify the path to your TikZ file
    \caption{1}
    \label{fig1}
     \end{figure}
    ...
    \item[70.]  In the T type master-slave $J_K$ flip flop is shown along with the clock and input waveforms. The $Q_n$ output of flip flop was zero initially. Identify the correct output waveform.
     ...
     \begin{figure}[!ht]
      \centering
      \input{codes/fig_2.tex}  % Specify the path to your TikZ file
      \caption{ 2}
      \label{fig2}
     \end{figure}
     ...
     \begin{figure}[!ht]
      \centering
      \input{codes/fig_3.tex}  % Specify the path to your TikZ file
      %\caption{ 2}
      %\label{fig2}
     \end{figure}
        \begin{figure}[!ht]
          \centering
          \input{codes/fig_4.tex}  % Specify the path to your TikZ file
       %   \caption{ 4}
         % \label{fig 4}
            \end{figure}
      ...
      \begin{figure}[!ht]
        \centering
        \input{codes/fig_5.tex}  % Specify the path to your TikZ file
        %\caption{ 5}
        %\label{fig 5}
    \end{figure}
    \begin{figure}[!ht]
      \centering
      \input{codes/fig_6.tex}  % Specify the path to your TikZ file
      %\caption{ 6}
      %\label{fig 6}
       \end{figure}
    ...
    \begin{figure}[!ht]
      \centering
      \input{codes/fig_7.tex}  % Specify the path to your TikZ file
      \caption{ 7}
      \label{fig 7}
  \end{figure}
    ...
    \begin{figure}[!ht]
      \centering
      \input{codes/fig_8.tex}  % Specify the path to your TikZ file
      \caption{ 8}
      \label{fig 8}
  \end{figure}
    ...
    \begin{figure}[!ht]
      \centering
      \input{codes/fig_9.tex}  % Ensure the correct path to fig_9.tex
